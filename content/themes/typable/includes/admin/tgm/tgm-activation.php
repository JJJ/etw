 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Typable
...
add_action( 'tgmpa_register', 'typable_register_required_plugins' );
 ...
 */
function typable_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'WPForms Lite',
			'slug'      => 'wpforms-lite',
 ...
 */
add_filter( 'wpforms_shareasale_id', 'typable_wpforms_shareasale_id' );

function typable_wpforms_shareasale_id( $shareasale_id ) {
