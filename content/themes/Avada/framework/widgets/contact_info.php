<?php
if ( ! class_exists( 'Fusion_Contact_Info_Widget' ) ) {
	add_action('widgets_init', 'fusion_contact_info_load_widgets');

	function fusion_contact_info_load_widgets()
	{
		register_widget('Fusion_Contact_Info_Widget');
	}

	class Fusion_Contact_Info_Widget extends WP_Widget {

		function Fusion_Contact_Info_Widget()
		{
