<?php
if ( ! class_exists( 'Fusion_Tweets_Widget' ) ) {
	add_action('widgets_init', 'fusion_tweets_load_widgets');

	function fusion_tweets_load_widgets()
	{
		register_widget('Fusion_Tweets_Widget');
	}

	class Fusion_Tweets_Widget extends WP_Widget {

		function Fusion_Tweets_Widget()
		{
		...
		function form($instance)
		{
			...
			<p><a href="<?php echo $twitter_apps_url; ?>">Find or Create your Twitter App</a></p>
			<p>
