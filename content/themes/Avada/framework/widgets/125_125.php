<?php
if ( ! class_exists( 'Fusion_Ad_125_125_Widget' ) ) {
	add_action('widgets_init', 'fusion_ad_125_125_load_widgets');

	function fusion_ad_125_125_load_widgets()
	{
		register_widget('Fusion_Ad_125_125_Widget');
	}

	class Fusion_Ad_125_125_Widget extends WP_Widget {

		function Fusion_Ad_125_125_Widget()
		{
