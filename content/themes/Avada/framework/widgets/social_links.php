<?php
if ( ! class_exists( 'Fusion_Recent_Works_Widget' ) ) {
	add_action('widgets_init', 'fusion_social_links_load_widgets');

	function fusion_social_links_load_widgets()
	{
		register_widget('Fusion_Social_Links_Widget');
	}

	class Fusion_Social_Links_Widget extends WP_Widget {

		function Fusion_Social_Links_Widget()
		{
		...
		function form($instance)
		{
			...
			<p>
				<label for="<?php echo $this->get_field_id('icons_font_size'); ?>">Icons Font Size:</label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('boxed_icon_padding'); ?>">Boxed Icons Padding:</label>
