...
( function($) {
  ...
  $(document).ready(function() {
    ...
    xCustomizerText( 'x_root_font_size_mode',                           false,                                  'Select the method for outputting your site\'s root font size, then adjust the settings to suit your design. The "Stepped" mode allows you to set a font size at each of your site\'s breakpoints, whereas the "Scaling" option will dynamically scale between a range of minimum and maximum font sizes and breakpoints that you specify.' );
