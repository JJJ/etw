 ...
 * @version   2.6.1 for parent theme X for publication on ThemeForest
					...
					public function add_strings() {
						if ( 'update' === $this->options['install_type'] ) {
							...
							if ( $this->tgmpa->is_automatic ) {
								...
								/* translators: 1: plugin name. */
								$this->upgrader->strings['skin_update_successful'] = __( '%s installed and activated successfully.', 'tgmpa' );
								...
								/* translators: 1: plugin name. */
								$this->upgrader->strings['skin_update_successful'] = esc_html__( '%s installed successfully.', 'tgmpa' );
