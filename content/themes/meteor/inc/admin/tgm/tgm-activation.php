 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme meteor
...
add_action( 'tgmpa_register', 'meteor_register_required_plugins' );
 ...
 */
function meteor_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'WPForms Lite',
			'slug'      => 'wpforms-lite',
 ...
 */
add_filter( 'wpforms_shareasale_id', 'meteor_wpforms_shareasale_id' );

function meteor_wpforms_shareasale_id( $shareasale_id ) {
