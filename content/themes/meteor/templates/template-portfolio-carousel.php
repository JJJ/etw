...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			...
			<div class="section-portfolio section-portfolio-carousel">
			    ...
			    <?php
			        ...
			        $posts_per_page = get_theme_mod( 'meteor_portfolio_carousel_count', '10' );
			        ...
			        if ( post_type_exists( 'jetpack-portfolio' ) && $project_query -> have_posts() ) :
						...
						get_template_part( 'template-parts/content-portfolio-carousel' );
			...
			<div class="carousel-navs">
				<button class="carousel-prev"><i class="fa fa-angle-left"></i></button>
				<button class="carousel-next"><i class="fa fa-angle-right"></i></button>
			</div>
