...
<?php
	$blog_section = get_theme_mod( 'meteor_portfolio_blog_section', 'enabled' );
...
<div class="blog-section">
	<div class="container">
		<?php
			$blog_section_title = get_theme_mod( 'meteor_portfolio_blog_text', esc_html__( 'Latest from the blog', 'meteor' ) );
			...
			if ( $blog_section_title ) {
				...
				if ( $post_count > 3 ) {
					echo '<a class="view-all-posts" href="' . esc_url( get_permalink( get_option( 'page_for_posts' ) ) ) . '"><i class="fa fa-file-text-o"> </i>' . esc_html__( 'View All', 'meteor' ) . '</a>';
				}
			}
		?>
	...
	<div class="container">
		...
		<div class="footer-bottom">
			<div class="footer-tagline">
				<div class="site-info">
					<?php echo meteor_filter_footer_text(); ?>
				</div>
			</div><!-- .footer-tagline -->
