...
?>
	<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="index-text">
			...
			<!-- Media archive link-->
			<a class="button lightbox-button video-archive-link" aria-hidden="true" href="<?php echo get_post_format_link( get_post_format() ); ?>"><span class="view-all"> <i class="fa fa-video-camera"></i> <?php echo get_post_format_string( get_post_format() ); ?> <?php esc_html_e( 'Archive', 'lenscap' ); ?></span></a>
