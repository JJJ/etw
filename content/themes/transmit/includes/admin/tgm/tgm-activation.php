 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Transmit
...
add_action( 'tgmpa_register', 'transmit_register_required_plugins' );
 ...
 */
function transmit_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'WPForms Lite',
			'slug'      => 'wpforms-lite',
 ...
 */
add_filter( 'wpforms_shareasale_id', 'transmit_wpforms_shareasale_id' );

function transmit_wpforms_shareasale_id( $shareasale_id ) {
