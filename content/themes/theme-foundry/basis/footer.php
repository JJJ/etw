	...
	<div class="footer-wrapper">
		...
		<section class="fine-print">
			...
			<p class="theme-byline">
				...
				<?php printf( __( 'Theme: %1$s by %2$s.', 'basis' ), 'Basis', '<a href="http://thethemefoundry.com/" rel="designer">The Theme Foundry</a>' ); ?>
				<?php else : ?>
				<a title="<?php esc_attr_e( 'Theme info', 'basis' ); ?>" href="http://thethemefoundry.com/wordpress/basis/">Basis theme</a> <span class="by"><?php _e( 'by', 'basis' ); ?></span> <a title="<?php esc_attr_e( 'The Theme Foundry home page', 'basis' ); ?>" href="http://thethemefoundry.com/">The Theme Foundry</a>
				<?php endif; ?>
			</p>
		</section>
