 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Atomic
...
add_action( 'tgmpa_register', 'atomic_register_required_plugins' );
 ...
 */
function atomic_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'WPForms Lite',
			'slug'      => 'wpforms-lite',
 ...
 */
add_filter( 'wpforms_shareasale_id', 'atomic_wpforms_shareasale_id' );

function atomic_wpforms_shareasale_id( $shareasale_id ) {
