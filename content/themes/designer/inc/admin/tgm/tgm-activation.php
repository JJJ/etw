 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Designer
 ...
 */
add_filter( 'wpforms_shareasale_id', 'designer_wpforms_shareasale_id' );

function designer_wpforms_shareasale_id( $shareasale_id ) {
