 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Candid
...
add_action( 'tgmpa_register', 'candid_register_required_plugins' );
 ...
 */
function candid_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'WPForms Lite',
			'slug'      => 'wpforms-lite',
 ...
 */
add_filter( 'wpforms_shareasale_id', 'candid_wpforms_shareasale_id' );

function candid_wpforms_shareasale_id( $shareasale_id ) {
