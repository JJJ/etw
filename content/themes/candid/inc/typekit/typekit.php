...
class Array_Typekit_Library {
	...
	function customize_register( $wp_customize ) {
		...
		$wp_customize->add_control( 'disable_typekit', array(
			'type'            => 'checkbox',
			'label'           => __( 'Disable Typekit', 'candid' ),
			'description'     => __( 'Check to disable the Typekit fonts included with this theme if you would like to use your own fonts.', 'candid' ),
			'section'         => 'typekit',
