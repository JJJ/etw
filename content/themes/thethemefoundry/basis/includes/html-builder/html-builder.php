...
class Basis_HTML_Builder {
	...
	?>
		<div class="basis-uploader">
			...
			<input type="hidden" name="<?php echo $section_name; ?>[image-id]" value="<?php echo absint( $image_id ); ?>" class="basis-media-uploader-value" />
		</div>
	<?php
	}
	...
	private function _load_section( $section, $data = array(), $builder = '' ) {
		...
		global $basis_section, $basis_builder, $basis_section_data, $basis_section_name, $basis_is_js_template;
