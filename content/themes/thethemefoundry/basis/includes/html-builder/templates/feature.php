...
<?php $order = ( isset( $basis_section_data['order'] ) ) ? implode( ',', $basis_section_data['order'] ) : 'basis-section-feature-image,basis-section-feature-text'; ?>
	...
	<div class="basis-section-sortable-stage basis-section-sortable-stage-feature">
		...
		<div class="basis-feature-column basis-sortable" id="basis-section-feature-image">
			...
			<div class="basis-titlediv">
				<input placeholder="<?php esc_attr_e( 'Enter link here' ); ?>" type="text" name="<?php echo $basis_section_name; ?>[image-link]" class="basis-link widefat" value="<?php if ( isset( $basis_section_data['image-link'] ) ) echo esc_url( $basis_section_data['image-link'] ); ?>" autocomplete="off" />
			</div>
		...
		<div class="basis-feature-column basis-sortable" id="basis-section-feature-text">
			...
			<div class="basis-titlediv">
				<input placeholder="<?php esc_attr_e( 'Enter link here' ); ?>" type="text" name="<?php echo $basis_section_name; ?>[title-link]" class="basis-link widefat" value="<?php if ( isset( $basis_section_data['title-link'] ) ) echo esc_url( $basis_section_data['title-link'] ); ?>" autocomplete="off" />
			</div>
			...
			<?php else : ?>
				...
				<?php basis_get_html_builder()->wp_editor( $content, $basis_section_name . '[content]', array( 'editor_height' => 125 ) ); ?>
			<?php endif; ?>
		</div>
	...
	<input type="hidden" class="basis-section-order" name="<?php echo $basis_section_name; ?>[order]" value="<?php echo esc_attr( $order ); ?>" />
