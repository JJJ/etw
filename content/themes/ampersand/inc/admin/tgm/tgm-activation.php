 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Ampersand
...
add_action( 'tgmpa_register', 'ampersand_register_required_plugins' );
 ...
 */
function ampersand_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'WPForms Lite',
			'slug'      => 'wpforms-lite',
 ...
 */
add_filter( 'wpforms_shareasale_id', 'ampersand_wpforms_shareasale_id' );

function ampersand_wpforms_shareasale_id( $shareasale_id ) {
