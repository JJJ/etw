 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Verb
...
add_action( 'tgmpa_register', 'verb_register_required_plugins' );
 ...
 */
function verb_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'WPForms Lite',
			'slug'      => 'wpforms-lite',
 ...
 */
add_filter( 'wpforms_shareasale_id', 'verb_wpforms_shareasale_id' );

function verb_wpforms_shareasale_id( $shareasale_id ) {
