 ...
 * mce_buttons_2 hook.
 */
function verb_mce_buttons_2( $buttons ) {

  array_unshift( $buttons, 'styleselect' );
  return $buttons;
}
add_filter( 'mce_buttons_2', 'verb_mce_buttons_2' );
 ...
 */
function verb_tiny_mce_before_init( $settings ) {

	$settings['theme_advanced_blockformats'] = 'p,a,div,span,h1,h2,h3,h4,h5,h6,tr,';

	$style_formats = array(
		array( 'title' => 'Page Title', 'block'  => 'div',  'classes' => 'intro' ),
		array( 'title' => 'Pull Quote', 'block'  => 'div',  'classes' => 'pull-quote' ),
...
add_filter( 'tiny_mce_before_init', 'verb_tiny_mce_before_init' );
...
function verb_add_editor_style() {
  add_editor_style( 'style-editor.css' );
}
add_action( 'after_setup_theme', 'verb_add_editor_style' );
