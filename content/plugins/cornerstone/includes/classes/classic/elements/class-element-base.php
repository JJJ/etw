...
abstract class Cornerstone_Element_Base {
	...
	public function flags() {
		return array(
			...
			'library'           => $this->data['context'] === 'all' ? $this->data['library'] : false,
      ...
      '_no_server_render'  => $this->data['_no_server_render'],
