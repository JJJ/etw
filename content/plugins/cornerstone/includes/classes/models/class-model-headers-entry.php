...
class Cornerstone_Model_Headers_Entry extends Cornerstone_Plugin_Component {

  public $resources = array();
  public $name = 'headers/entry';
  ...
  public function setup() {
    ...
    $posts = $wpdb->get_results( "SELECT ID, post_title, post_name, post_modified, post_date  FROM $wpdb->posts WHERE post_type = \"cs_header\"", ARRAY_A );
    ...
    foreach ($posts as $post) {
      ...
      $records[] = array(
        ...
        'language' => $this->plugin->component('Wpml')->get_language_data( $post['ID'], 'cs_header' )
      );
