...
abstract class MAKEPLUS_Util_Modules implements MAKEPLUS_Util_ModulesInterface {
	...
	protected function add_module( $module_name, $module ) {
		...
		if ( ! $this->has_module( $module_name ) ) {
			...
			if ( $this->modules[ $module_name ] instanceof MAKEPLUS_Util_HookInterface || $this->modules[ $module_name ] instanceof MAKE_Util_HookInterface ) {
	 ...
	 * @param array                      $modules
	 */
	protected function load_dependencies( MAKEPLUS_APIInterface $api = null, array $modules = array() ) {
	...
	public function get_module( $module_name ) {
		// Module exists.
		if ( $this->has_module( $module_name ) ) {
			if ( $this->modules[ $module_name ] instanceof MAKEPLUS_Util_LoadInterface || $this->modules[ $module_name ] instanceof MAKE_Util_LoadInterface ) {
