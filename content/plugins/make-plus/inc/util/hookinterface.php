...
/**
 * Interface MAKEPLUS_Util_HookInterface
 *
 * Classes that implement this interface will have their hook() method called automatically when they are added as
 * a module to a class that is an instance of MAKEPLUS_Util_Modules via the add_module() method.
 *
 * In addition to the two methods in this interface, a MAKEPLUS_Util_HookInterface class should have a static $hooked
