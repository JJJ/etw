 ...
 * a module from a class that is an instance of MAKEPLUS_Util_Modules via the get_module() method.
 *
 * In addition to the two methods in this interface, a MAKEPLUS_Util_LoadInterface class should have a $loaded
 ...
 * @since 1.7.0.
 */
interface MAKEPLUS_Util_LoadInterface {
