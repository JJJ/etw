...
/**
 * Class MAKEPLUS_Component_PostsList_Filter
 *
...
final class MAKEPLUS_Component_PostsList_Filter extends MAKEPLUS_Util_Modules implements MAKEPLUS_Component_PostsList_FilterInterface {
	...
	private function get_choice_list( $post_type ) {
		...
		if ( has_filter( 'ttfmp_post_list_filter_choices' ) ) {
			 ...
			 */
			$choice_list = apply_filters( 'ttfmp_post_list_filter_choices', $choice_list, $post_type );
		}
		 ...
		 * @param string $post_type      The ID of the post type to retrieve filter choices for.
		 */
		return apply_filters( 'makeplus_postslist_filter_choices', $choice_list, $post_type );
	}
