...
$fusion_shortcodes['contentboxes'] = array(
	'params' => array(
		...
		'icon_circle' => array(
			...
			'desc' => __( 'Controls the circle behind the icon. Select default for theme option selection.', 'fusion-core' ),
			'options' => array(
				'default' => __('Default', 'fusion-core'),
		...
		'icon_align' => array(
			...
			'desc' =>  __( 'Works with "Icon beside Title",  "Content aligned with Title" and "Icon Beside Title" layout options.' ),
	...
	'shortcode' => '[content_boxes layout="{{layout}}" title_size="{{title_size}}" icon_circle="{{icon_circle}}" icon_size="{{icon_size}}" icon_align="{{icon_align}}" columns="{{columns}}" margin_top="{{margin_top}}" margin_bottom="{{margin_top}}" class="{{class}}" id="{{id}}"]{{child_shortcode}}[/content_boxes]', // as there is no wrapper shortcode
...
$fusion_shortcodes['imagecarousel'] = array(
	...
	'shortcode' => '[images picture_size="{{picture_size}}" autoplay="{{autoplay}}" columns="{{columns}}" column_spacing="{{column_spacing}}" scroll_items="{{scroll_items}}" show_nav="{{show_nav}}" mouse_scroll="{{mouse_scroll}}" border="{{border}}" lightbox="{{lightbox}}" class="{{class}}" id="{{id}}"]{{child_shortcode}}[/images]', // as there is no wrapper shortcode
...
$fusion_shortcodes['separator'] = array(
	...
	'shortcode' => '[separator style_type="{{style_type}}" top_margin="{{topmargin}}" bottom_margin="{{bottommargin}}"  sep_color="{{sepcolor}}" icon="{{icon}}" icon_circle="{{icon_circle}}" icon_circle_color="{{icon_circle_color}}" width="{{width}}" alignment="{{alignment}}" class="{{class}}" id="{{id}}"]',
...
$fusion_shortcodes['title'] = array(
	...
	'shortcode' => '[title size="{{size}}" content_align="{{contentalign}}" style_type="{{style_type}}" sep_color="{{sepcolor}}" class="{{class}}" id="{{id}}"]{{content}}[/title]',
	'popup_title' => __( 'Sharing Box Shortcode', 'fusion-core' )
);
